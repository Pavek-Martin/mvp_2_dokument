...
echo "1"
%mpvpl% --speed=1 --start=00:00:31.000 --end=00:00:37 %filename%

echo pejsci
echo "2"
%mpvpl% --speed=1 --start=00:06:25.500 --end=00:06:37 %filename%

echo 3x a-b slalom, barevne u nafukovaci haly Strahov
echo "3"
%mpvpl% --mute --speed=0.33 --start=00:06:41.000 --ab-loop-count=2 --ab-loop-a=00:06:41.000 --ab-loop-b=00:06:43.300 --end=00:06:43.301 %filename%

REM
echo "4"
%mpvpl% --mute --speed=0.33 --start=00:11:15.000 --end=00:11:17.000 %filename%

REM
echo "5"
%mpvpl% --mute --speed=0.25 --start=00:12:33.500 --end=00:12:35.000 %filename%

echo tady se nejsem jiste jestli Strahov nebo nekde jinde
echo "6"
%mpvpl% --mute --speed=0.33 --start=00:12:43.000 --end=00:12:50.000 %filename%

REM
echo "7"
%mpvpl% --mute --speed=0.33 --start=00:13:14.000 --end=00:13:21.700 %filename%

echo kombinovanej zaber minulost/soucasnost, neslo to udelat jinak
echo "8"
%mpvpl%  --speed=1 --start=00:16:17.000 --end=00:16:34.000 %filename%
REM --speed 1 by samozdrejme nemuselo bejt protoze to je default, je to tam jenom kvuli pripadny editaci

echo rampa asi este pred "uckem"
echo "9"
%mpvpl%  --speed=1 --start=00:16:59.000 --end=00:17:14.500 %filename%

echo barevnej zaber, dlouhej
echo "10"
%mpvpl%  --speed=1 --start=00:17:44.700 --end=00:18:19.000 %filename%
...
echo "11"
%mpvpl%  --speed=1 --start=00:18:46.600 --end=00:19:33.500 %filename%
...
echo "12"
%mpvpl%  --speed=1 --start=00:20:28.000 --end=00:20:49.000 %filename%

echo tady radeji bez zvuku
echo "13"
%mpvpl%  --mute --speed=0.5 --start=00:21:04.600 --end=00:21:20.500 %filename%

echo tohle nepamatuju ale urcite to je dobovy
echo "14"
%mpvpl% --speed=1 --start=00:24:07.500 --end=00:24:42.000 %filename%

echo opakuje usek A-B 3x a pak ukonci
echo pozor --ab-loop-count=2 ( opakuje 3x a ne 2x jak by se mohlo zdat, nezjisteno proc )
echo "15"
%mpvpl%  --mute --speed=0.5 --start=00:25:51.000 --ab-loop-count=2 --ab-loop-a=00:25:51.000 --ab-loop-b=00:25:57.500 --end=00:25:57.501 %filename%

REM
echo "16"
%mpvpl%  --mute --speed=0.3 --start=00:28:37.000 --end=00:28:43.000 %filename%

echo 3x A-B slalom kuzelky
echo "17"
%mpvpl%  --mute --speed=1 --start=00:31:34.000 --ab-loop-count=2 --ab-loop-a=00:31:34.000 --ab-loop-b=00:31:50.700 --end=00:31:50.701 %filename%

REM
echo "18"
%mpvpl%  --mute --speed=1 --start=00:31:56.000 --end=00:32:00.000 %filename%

echo jump 155cm
echo 19"
%mpvpl% --speed=1 --start=00:33:06.000 --end=00:33:13.500 %filename%

echo 3x a-b skok
echo "20"
%mpvpl% --mute --speed=1 --start=00:34:49.000 --ab-loop-count=2 --ab-loop-a=00:34:49.000 --ab-loop-b=00:35:07.300 --end=00:35:07.301 %filename%

echo rampa, nevim kde
echo "21"
%mpvpl% --mute --speed=0.5 --start=00:37:56.000 --end=00:38:03.800 %filename%

echo zase ucko
echo "22"
%mpvpl% --mute --speed=0.3 --start=00:40:41.200 --end=00:40:43.100 %filename%

REM
echo "23"
%mpvpl% --mute --speed=0.5 --start=00:41:32.100 --end=00:41:48.000 %filename%

REM
echo "24"
%mpvpl% --mute --speed=0.5 --start=00:43:00.000 --end=00:43:03.100 %filename%

REM
echo "25"
%mpvpl% --mute --speed=0.5 --start=00:43:17.000 --end=00:43:32.000 %filename%

echo tahle holka myslim hrala v serialu treti patro z Lukasem Vaculikem, jeste jednou teda detail
echo "26"
%mpvpl% --mute --speed=0.2 --start=00:43:31.000 --end=00:43:32.200 %filename%

echo opravdova momentka ( Strahov )
echo "27"
%mpvpl% --mute --speed=0.2 --start=00:53:40.000 --end=00:53:41.000 %filename%

echo najaka krasavice, ale buh vi kde a tak je to jedno
echo "28"
%mpvpl% --mute --speed=0.3 --start=00:54:27.000 --end=00:54:30.300 %filename%

echo vesela scena, buh vi odkud
echo "29"
%mpvpl% --speed=1 --start=00:55:56.300 --end=00:56:08.000 %filename%

REM
echo "30"
%mpvpl% --mute --speed=1 --start=00:56:58.000 --end=00:57:02.500 %filename%

echo strahov
echo "31"
%mpvpl% --mute --speed=1 --start=00:58:30.000 --end=00:59:01.000 %filename%

echo holka 3x a-b
echo dreveny spulky na kabely pamatuju a ta ctverckovana zed je my povedoma
echo "32"
%mpvpl% --mute --speed=0.5 --start=00:58:35.900 --ab-loop-count=2 --ab-loop-a=00:58:35.900 --ab-loop-b=00:58:40.800 --end=00:58:40.801 %filename%

REM
echo "33"
%mpvpl% --mute --speed=0.5 --start=01:16:19.000 --end=01:16:23.000 %filename%

echo u nafukovaci haly
echo "34"
%mpvpl% --mute --speed=0.5 --start=01:18:28.600 --end=01:18:29.900 %filename%

echo strahov 3x a-b ZAVERECNY
echo "35"
%mpvpl% --mute --speed=0.5 --start=01:18:31.200 --ab-loop-count=2 --ab-loop-a=01:18:31.200 --ab-loop-b=01:18:36.900 --end=01:18:36.901 %filename%

echo hodi se na konec
echo "36"
%mpvpl% --mute --speed=0.5 --start=01:19:00.500 --end=01:19:03.000 %filename%
